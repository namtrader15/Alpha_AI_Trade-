...
class BinanceDataCollector:
    ...
    def fetch_ohlcv(self, symbol, interval='1h', months_back=1):
...
def main():
    ...
    ohlcv_data = collector.fetch_ohlcv(symbol, interval='1h', months_back=1)
    ...
    if not ohlcv_data.empty:
        collector.save_to_csv(ohlcv_data, f"{symbol}1month_ohlcv_with_indicators.csv")
################################################
        # Render to Final_Dataset
    # Đọc dữ liệu từ file
    file_path = "ETHUSDT1month_ohlcv_with_indicators.csv"
    ...
    processed_file_path = "1month_ETHUSDT_processed_f32.csv"
